...
typedef std::shared_ptr<RecommenderSystem> rec_sp;
typedef std::unordered_map<sp_movie, double, hash_func,equal_func> rank_map;

class RSUser
{
private:
    std::string _user_name; // user name
    rec_sp _recommender_system; // the recommand system the user connected to
    rank_map _user_rank_map; // user ratings of the movies
...
public:
	 ...
	 */
	RSUser(const std::string& name , rank_map& user_rank_map ,
